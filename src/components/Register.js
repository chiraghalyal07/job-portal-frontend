...
//             errors.password='password should be betweetn 8 to 128 characters '
//         }
...
//                 setCheckEmail(response.data.exists)
//             }
            
//             console.log(response.data.exists)
//         }catch(error){
//             console.log('Error checking email existance : ',error)
//         }
//     }
...
//     if (serverErrors) {
//         return serverErrors
//             .filter(ele => ele.path === field) // Filter errors based on the parameter
//             .map((error, i) => (
//                 <li key={i}>{error.msg}</li> // Display the error message
//             ));
//     }
//     return null;
// };
...
//                 {checkEmail && <p>Email already exists</p>}
//                 { showError('email') } <br />
...
//                 <div style={{display:'inline-block',marginLeft:'25px'}}></div>
